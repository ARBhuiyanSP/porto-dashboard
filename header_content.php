<header class="header">
	...
	<div class="header-right">
		...
		<ul class="notifications">
			<li>
				<a class="nav-link" id="MyClockDisplay" style="color:#000000;font-weight:bold;"><i class="fas fa-clock-o"></i></a>
			</li>
		</ul>
		...
		<div id="userbox" class="userbox">
			...
			<div class="dropdown-menu">
				<ul class="list-unstyled mb-2">
					...
					<li>
						<a role="menuitem" tabindex="-1" href="index.php"><i class="bx bx-power-off"></i> Logout</a>
					</li>
				</ul>
			</div>
		</div>
